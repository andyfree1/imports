...
const skills = [
  ...
  },
  {
    ...
    technologies: [
      'Projects with Tony Robbins',
      'Projects with Jordan Belfort',
      'Projects with Joe Verde',
      'Projects with Tom Hopkins',
      'AI-powered CRM Systems',
      'SRM Systems Development'
    ]
  },
  {
                  ...
                  <div className="text-sm text-white/80 mt-4">
                    <div className="flex flex-wrap gap-2 justify-center">
                      {skill.technologies.map((tech, index) => (
                        <span
                          key={tech}
                          className="px-3 py-1 rounded-full bg-white/10 hover:bg-white/20 transition-colors cursor-default"
                          style={{
